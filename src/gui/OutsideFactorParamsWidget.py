...
class OutsideFactorParamsWidget(QWidget):
    ...
    def initUI(self):
        ...
        initNumVLay.addWidget(QLabel(" wpływ zew. na ofiary "))
        initNumVLay.addWidget(self.victimsFactor)
        initNumVLay.addSpacing(20)
        initNumVLay.addWidget(QLabel(" wpływ zew. na drapieżniki "))
        initNumVLay.addWidget(self.predatorsFactor)
        initNumVLay.addSpacing(20)
